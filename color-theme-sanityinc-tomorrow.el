...
(defconst color-theme-sanityinc-tomorrow-colors
  '((night . ((background . "#24272d")
              ...
              (blue . "#72aee9")
              (purple . "#B481BB")))
    (day . ((background . "#f6fff9")
            (alt-background . "#f6fff9ff")
            (current-line . "#B5CAA0")
            (selection . "#C7E9BB")
            (foreground . "#34494a")
            (comment . "#8e908c")
  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      ;; org-modern
      (org-modern-date-active (:inherit org-modern-label :foreground ,green :inverse-video t))
      (org-modern-date-inactive (:inherit org-modern-label :foreground ,orange :inverse-video t))
      (org-modern-done (:inherit org-modern-label :foreground ,green :inverse-video t))
      ...
      (org-modern-tag (:inherit org-modern-label :foreground ,purple :inverse-video t))

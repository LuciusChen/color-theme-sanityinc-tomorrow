  ...
  (quote
   (mapcar
    ...
    `(;; Standard font lock faces
      ...
      ;; diff-mode (built-in)
      (diff-added (:foreground ,leaf :extend t))
      (diff-changed (:foreground ,pine))
      (diff-removed (:foreground ,gold :extend t))
      (diff-header (:foreground ,foam :background unspecified :extend t))
      (diff-file-header (:foreground ,pine :background unspecified :extend t))
      (diff-hunk-header (:foreground ,iris))
      (diff-indicator-added (:inherit diff-added))
      (diff-indicator-changed (:inherit diff-changed))
      (diff-indicator-removed (:inherit diff-removed))
      (diff-refine-added (:foreground ,foam))
      ...
      (diff-hl-change (:foreground ,background :background ,pine))
      ...
      (magit-diff-added (:foreground ,leaf :extend t))
      (magit-diff-added-highlight (:foreground ,leaf :background ,highlight :extend t))
      (magit-diff-base (:foreground ,background :background ,gold :extend t))
      (magit-diff-base-highlight (:foreground ,gold :background ,highlight :extend t))
      ...
      (magit-diff-removed (:foreground ,gold :extend t))
      (magit-diff-removed-highlight (:foreground ,gold :background ,highlight :extend t))
      (magit-diffstat-added (:foreground ,leaf))
      (magit-diffstat-removed (:foreground ,gold))
